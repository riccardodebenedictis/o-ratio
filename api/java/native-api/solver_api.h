...
extern "C" {
     ...
     */
    JNIEXPORT jboolean JNICALL Java_it_cnr_istc_ratio_api_Solver_read__Ljava_lang_String_2(JNIEnv *, jobject, jstring);
     ...
     * Signature: ([Ljava/lang/String;)Z
     */
    JNIEXPORT jboolean JNICALL Java_it_cnr_istc_ratio_api_Solver_read___3Ljava_lang_String_2(JNIEnv *, jobject, jobjectArray);
